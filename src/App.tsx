...
import { MonthWiseCSVUpload } from "./components/MonthWiseCSVUpload";
import { MonthWiseComparison } from "./components/MonthWiseComparison";
import {
        ...
        <Tabs defaultValue="directors" className="space-y-4">
          <TabsList className="grid w-full grid-cols-5 bg-white border border-gray-200 rounded-lg p-1">
            ...
            >
              ...
              <span>Month-Wise Comparison</span>
            </TabsTrigger>
            <TabsTrigger
          ...
          {/* Month-Wise Comparison Tab */}
          <TabsContent value="comparison" className="space-y-4">
            <MonthWiseComparison uploadedData={uploadedData} />
          </TabsContent>

          {/* Location-Based Upload Tab */}
          <TabsContent value="upload-location" className="space-y-4">
            <Card className="border-blue-200 bg-blue-50 shadow-sm mb-4">
              <CardContent className="pt-6">
                <div className="flex items-center space-x-3">
                  <MapPin className="h-5 w-5 text-blue-600" />
                  <div>
                    <p className="text-sm font-medium text-blue-900">Location-Based Upload (Legacy)</p>
                    <p className="text-xs text-blue-700 mt-1">
                      Upload CSV files for individual locations. For month-wise uploads with all locations, use the "Month Upload" tab.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          {/* Month-Wise Upload Tab */}
          <TabsContent value="upload-month" className="space-y-4">
            <Card className="border-green-200 bg-green-50 shadow-sm mb-4">
              <CardContent className="pt-6">
                <div className="flex items-center space-x-3">
                  <CalendarDays className="h-5 w-5 text-green-600" />
                  <div>
                    <p className="text-sm font-medium text-green-900">Month-Wise Upload (Recommended)</p>
                    <p className="text-xs text-green-700 mt-1">
                      Upload a single CSV file containing data for all 5 locations for a specific month. This enables month-wise comparison features.
                    </p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <MonthWiseCSVUpload onDataUpload={refreshDataFromDatabase} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
